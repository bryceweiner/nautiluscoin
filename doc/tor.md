...
1. Run nautiluscoin behind a Tor proxy
---------------------------------
...
In a typical situation, this suffices to run behind a Tor proxy:
	...
	./nautiluscoin -proxy=127.0.0.1:9050


2. Run a nautiluscoin hidden server
------------------------------
...
your nautiluscoind's P2P listen port (8333 by default).
	...
	-externalip=X   You can tell nautiluscoin about its publicly reachable address using
	                ...
	                /var/lib/tor/nautiluscoin-service/hostname. Onion addresses are given
...
In a typical situation, where you're only reachable via Tor, this should suffice:
	...
	./nautiluscoind -proxy=127.0.0.1:9050 -externalip=57qr3yd1nyntf5k.onion -listen
...
for normal IPv4/IPv6 communication, use:
	...
	./nautiluscoin -onion=127.0.0.1:9050 -externalip=57qr3yd1nyntf5k.onion -discover
