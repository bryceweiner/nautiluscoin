The following is a list of assets used in the nautiluscoin source and their proper attribution.
...
### Info
* Designer: Jonas Schnelli (based on the original nautiluscoin logo from Bitboy)
* License: MIT
