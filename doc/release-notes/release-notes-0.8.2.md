...
MacOSX:
* OSX support for click-to-pay (nautiluscoin:) links
...
* Entering the 'getblocktemplate' or 'getwork' RPC commands into the Nautiluscoin-Qt debug
console will cause Nautiluscoin-Qt to crash. Run Nautiluscoin-Qt with the -server command-line
