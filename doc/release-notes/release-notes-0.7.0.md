Nautiluscoin version 0.7.0 is now available for download at:
  http://sourceforge.net/projects/bitcoin/files/Bitcoin/bitcoin-0.7.0/

We recommend that everybody running prior versions of nautiluscoind/Nautiluscoin-Qt
...
Code:
/Applications/Nautiluscoin-Qt
(on Mac) or
Code:
nautiluscoind/nautiluscoin-qt
(on Linux).
...
Nautiluscoin Improvement Proposals implemented
...
Core nautiluscoin handling and blockchain database
...
* Ensure a changed nautiluscoin unit immediately updates all GUI elements that use units
...
* (Windows only): enable ASLR and DEP for nautiluscoin-qt.exe
* (Windows only): add meta-data to nautiluscoin-qt.exe (e.g. description)
...
* Bash programmable completion for nautiluscoind(1)
