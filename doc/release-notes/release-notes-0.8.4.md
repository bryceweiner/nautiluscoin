...
code, causing the Nautiluscoin-Qt or nautiluscoind process to crash.
...
Linux: clicking on nautiluscoin: links was broken if you were using
a Gnome-based desktop.

Fix a hang-at-shutdown bug that only affects users that compile
their own version of Nautiluscoin against Boost versions 1.50-1.52.
