Nautiluscoin version 0.5.4 is now available for download at:
...
http://gitorious.org/nautiluscoin/nautiluscoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Nautiluscoin-Qt notifications under Growl 1.3.
Increase required age of Nautiluscoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxNautiluscoin properly when installing Nautiluscoin-Qt over it. (Windows)
