...
Contains files used to package nautiluscoind/nautiluscoin-qt
...
A Linux bash script that will set up tc to limit the outgoing bandwidth for connections to the Nautiluscoin network. This means one can have an always-on nautiluscoind instance running, and another local nautiluscoind/nautiluscoin-qt instance which connects to this node and receives blocks from it.

### [Seeds](/contrib/seeds) ###
Utility to generate the pnSeed[] array that is compiled into the client.

### [TestGen](/contrib/testgen) ###
Utilities to generate test vectors for the data-driven Nautiluscoin tests.
