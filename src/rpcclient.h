...
#ifndef _NAUTILUSCOINRPC_CLIENT_H_
#define _NAUTILUSCOINRPC_CLIENT_H_ 1
...
/** Show help message for nautiluscoin-cli.
 ...
 *
 * @note the argument can be removed once nautiluscoin-cli functionality is removed from nautiluscoind
 */
