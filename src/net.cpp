...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("nautiluscoin-ext-ip");
...
static const char *strTestNetDNSSeed[][2] = {
    {"bitcoin.petertodd.org", "testnet-seed.nautiluscoin.petertodd.org"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Nautiluscoin is probably already running."), addrBind.ToString().c_str());
        else
