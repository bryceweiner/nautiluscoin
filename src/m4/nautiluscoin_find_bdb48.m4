AC_DEFUN([NAUTILUSCOIN_FIND_BDB48],[
  ...
  if test "x$bdbpath" = "xX"; then
    ...
    NAUTILUSCOIN_SUBDIR_TO_INCLUDE(BDB_CPPFLAGS,[${bdbpath}],db_cxx)
    ...
    NAUTILUSCOIN_SUBDIR_TO_INCLUDE(BDB_CPPFLAGS,[${bdb48path}],db_cxx)
    bdbpath="${bdb48path}"
  fi
