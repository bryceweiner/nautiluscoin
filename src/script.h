...
#ifndef H_NAUTILUSCOIN_SCRIPT
#define H_NAUTILUSCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CNautiluscoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, Nautiluscoin always counted CHECKMULTISIGs
