...
QT_TRANSLATE_NOOP("nautiluscoin-core", "Nautiluscoin version"),
...
QT_TRANSLATE_NOOP("nautiluscoin-core", "Invalid -tor address: '%s'"),
...
QT_TRANSLATE_NOOP("nautiluscoin-core", "Listen for connections on <port> (default: 9335 or testnet: 19335)"),
...
QT_TRANSLATE_NOOP("nautiluscoin-core", "Output extra debugging information. Implies all other -debug* options"),
QT_TRANSLATE_NOOP("nautiluscoin-core", "Output extra network debugging information"),
QT_TRANSLATE_NOOP("nautiluscoin-core", "Password for JSON-RPC connections"),
QT_TRANSLATE_NOOP("nautiluscoin-core", "Prepend debug output with timestamp"),
...
QT_TRANSLATE_NOOP("nautiluscoin-core", "Select the version of socks proxy to use (4-5, default: 5)"),
QT_TRANSLATE_NOOP("nautiluscoin-core", "Send command to -server or nautiluscoind"),
...
QT_TRANSLATE_NOOP("nautiluscoin-core", "Send trace/debug info to debugger"),
...
QT_TRANSLATE_NOOP("nautiluscoin-core", "Set maximum block size in bytes (default: 250000)"),
...
QT_TRANSLATE_NOOP("nautiluscoin-core", "Use proxy to reach tor hidden services (default: same as -proxy)"),
...
QT_TRANSLATE_NOOP("nautiluscoin-core", "You need to rebuild the databases using -reindex to change -txindex"),
