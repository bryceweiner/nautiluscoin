...
#include "nautiluscoin-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatNautiluscoinURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + NautiluscoinUnits::formatWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatNautiluscoinURI(info));
}
