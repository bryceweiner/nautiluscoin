...
/** Utility functions used by the Nautiluscoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Render Nautiluscoin addresses in monospace font
    ...
    // Parse "nautiluscoin:" URI into recipient object, return true on successful parsing
