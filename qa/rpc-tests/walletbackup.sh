...
B4ARGS="-datadir=$D4"
$NAUTILUSCOIND $NAUTILUSCOINDARGS $B4ARGS &
B4PID=$!
...
B3ARGS="-datadir=$D3"
$NAUTILUSCOIND $NAUTILUSCOINDARGS $B3ARGS &
B3PID=$!
...
function StartThree {
  $NAUTILUSCOIND $NAUTILUSCOINDARGS $B1ARGS &
  B1PID=$!
  $NAUTILUSCOIND $NAUTILUSCOINDARGS $B2ARGS &
  B2PID=$!
  $NAUTILUSCOIND $NAUTILUSCOINDARGS $B3ARGS &
  B3PID=$!
}
