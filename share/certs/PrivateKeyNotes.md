...
unlocked to sign the Nautiluscoin-Qt.app bundle.
...
allowing somebody to distribute a Nautiluscoin-Qt.app or nautiluscoin-qt-setup.exe with a valid
...
that the nautiluscoin-qt.exe file inside the installer had not been tampered with.
